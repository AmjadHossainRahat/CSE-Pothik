...
export function refineInfrastructureRoadmap(roadmap: Roadmap): Roadmap {
  ...
  if (roadmap.id === "network-engineering") {
    foundation.practicalTask = l(
      ...
      "ছোট network এঁকে দুটি non-overlapping subnet দিন; DNS resolution আর HTTP request trace করুন। কোন অংশ local আর কোনটিতে routing লাগে বলুন।",
    );
    foundation.enoughForNow = l(
      ...
      "Addressing, gateway, DNS আর transport আলাদা করে বোঝাতে আর নিজের machine-এ basic diagnostic tool ব্যবহার করতে পারেন।",
    );
    core.practicalTask = l(
      ...
      "বিচ্ছিন্ন simulator বা VM lab-এ দুই subnet যুক্ত করে route লিখে allowed traffic test করুন। একটি lab route ভেঙে evidence নিন আর ফিরিয়ে দিন।",
    );
    ...
    professional.practicalTask = l(
      ...
      "Lab change plan লিখে peer review করুন: impact, আগে-পরে check, stop condition আর rollback। সাহায্য না করে peer-কে চালাতে দিন।",
    );
    professional.enoughForNow = l(
      "A peer can reproduce the change, detect a failed check and recover the lab using your runbook.",
      "Peer আপনার runbook দিয়ে change reproduce, failed check detect আর lab recover করতে পারে।",
    );
    professional.notYet = [
      l(
  ...
  if (roadmap.id === "hardware-engineering") {
    foundation.practicalTask = l(
      ...
      "Truth table থেকে simulator-এ ছোট logic gate বানান। সব input combination test করুন; unit আর electrical limit আলাদা বোঝান।",
    );
    foundation.enoughForNow = l(
      "You can explain the logic and expected outputs, read a simple datasheet and identify what the simulation does not verify.",
      "Logic আর expected output বোঝাতে, সহজ datasheet পড়তে আর simulation কী verify করে না বলতে পারেন।",
    );
    core.practicalTask = l(
      ...
      "ছোট schematic-এর KiCad tutorial অনুসরণ করুন; datasheet দিয়ে pin আর rating যাচাই। Electrical rule check করে যুক্তিসঙ্গত exception লিখুন। এখনই fabricate নয়।",
    );
    ...
    practical.intent = l(
      ...
      "বিশ্বাসযোগ্য diagram থেকে স্পষ্ট verification-এ যান; simulator evidence আর physical measurement আলাদা।",
    );
    professional.topics = [
      l(
    ...
    professional.practicalTask = l(
      ...
      "Schematic, BOM, test case আর limit-সহ handover বানান। Physical build-এর আগে supervisor review নিন; simulation একা safety evidence নয়।",
    );
    professional.enoughForNow = l(
  ...
  if (roadmap.id === "software-quality-assurance") {
    foundation.practicalTask = l(
      ...
      "একটি local form-এর acceptance criteria, boundary case আর risk অনুযায়ী test charter লিখুন। একটি assertion লেখার মতো scripting শিখুন।",
    );
    foundation.enoughForNow = l(
      "You can separate requirement, observation and defect; write a reproducible report and explain an assertion.",
      "Requirement, observation আর defect আলাদা করতে, reproducible report লিখতে আর assertion বোঝাতে পারেন।",
    );
    core.practicalTask = l(
      ...
      "Local API-এর valid-invalid input test করে data isolate আর একটি deterministic check automate করুন। Severity আর fix priority আলাদা বোঝান।",
    );
    ...
    professional.practicalTask = l(
      ...
      "Critical journey check CI-এ দিন। পরিচিত local defect দিয়ে detect হয় দেখুন, fix করুন আর গুরুত্বপূর্ণ untested risk-সহ result জানান।",
    );
    professional.enoughForNow = l(
    ...
    professional.notYet = [
      l(
        ...
        "Coverage percentage-এর পেছনে ছুটবেন না; কারণ না বুঝে retry দিয়ে flaky failure লুকাবেন না।",
      ),
    ];
