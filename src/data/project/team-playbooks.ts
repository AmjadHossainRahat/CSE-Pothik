...
export const teamPlaybooks: ProjectPlaybook[] = [
  {
    ...
    title: l(
      ...
      "Team কীভাবে কাজ করবে, আগে ঠিক করো",
    ),
    ...
    summary: l(
      ...
      "একটি দরকারি outcome, বাস্তবসম্মত সময় আর shared agreement দিয়ে শুরু করো। Student team-এর দরকার স্পষ্টতা, ছোট আকারের corporate bureaucracy নয়।",
    ),
    steps: [
      {
        title: l("Write a one-page agreement", "এক পৃষ্ঠায় agreement লেখো"),
        body: l(
          ...
          "Rubric, deadline, class/exam বাদে সাপ্তাহিক সময়, যোগাযোগের channel, response window আর supervisor review date লেখো। Concern, অনুপস্থিতি আর contribution credit কীভাবে সামলাবে ঠিক করো। Commit count দিয়ে কাউকে rank কোরো না।",
        ),
      },
      {
        title: l(
          "Share ownership, rotate responsibilities",
          "Ownership ভাগ করো, দায়িত্ব rotate করো",
        ),
        body: l(
          ...
          "প্রতি issue-তে একজন owner আর আলাদা reviewer রাখো। Meeting facilitation, release coordination আর quality check rotate করো; QA সবার দায়িত্ব। Risky কাজ pair-এ করো, যেন critical module শুধু একজনই না বোঝে। Solo হলে peer বা supervisor দিয়ে milestone review করাও।",
        ),
      },
      {
        title: l(
          "Plan backward from evidence",
          "Evidence থেকে উল্টো দিকে plan করো",
        ),
        body: l(
          ...
          "ছোট end-to-end milestone ঠিক করে এক সপ্তাহের iteration-এ কাজ করো। Review, testing, integration আর exam-এর সময় রাখো। Risk list-এ owner, early warning আর fallback রাখো। Data বা hardware access অনিশ্চিত হলে feature promise করার আগেই তা যাচাই করো।",
        ),
      },
      {
        title: l(
          "Trade scope, not sleep or evidence",
          "Scope কমাও, ঘুম বা evidence নয়",
        ),
        body: l(
          ...
          "নতুন কাজ এলে benefit, cost আর risk লেখো; team ও supervisor-এর সঙ্গে কম জরুরি কাজ বাদ দিয়ে সেটি নাও। Cut list দৃশ্যমান রাখো। Submission buffer-এর আগে অপ্রয়োজনীয় feature freeze করো; সব testing বা report শেষ সপ্তাহে রেখো না।",
        ),
      },
    ],
    example: {
      ...
      lines: [
        l(
          ...
          "সপ্তাহ ১–২: problem, permission, brief আর repo ঠিক করো; সবচেয়ে বড় risk যাচাই করো। সপ্তাহ ৩–৪: একটি tested vertical slice demo করো।",
        ),
        l(
          ...
          "সপ্তাহ ৫–৮: প্রতি সপ্তাহে review ও test-সহ শুধু core slice যোগ করো। সপ্তাহ ৯–১০: integration, evaluation, repair আর recovery rehearsal করো; নতুন scope বন্ধ করো।",
        ),
        l(
          ...
          "সপ্তাহ ১১–১২: অন্য কাউকে দিয়ে clean setup, final evidence, report আর defense rehearsal করো। Report পুরো সময় জুড়েই লেখো। নিজের semester আর approval অনুযায়ী এই উদাহরণ বদলাও।",
        ),
      ],
    },
  ...
  },
  {
    ...
    title: l(
      ...
      "Idea-কে ছোট, যাচাইযোগ্য task-এ ভাঙো",
    ),
    when: l(
    ...
    summary: l(
      ...
      "একটি shared task manager-এ আসল অবস্থা রাখো। Outcome আর evidence track করো—শুধু “frontend করো” ধরনের অস্পষ্ট card নয়।",
    ),
    steps: [
      {
        title: l("Set up a small board", "ছোট board বানাও"),
        body: l(
          ...
          "GitHub Issues-এর পাশে GitHub Projects দিয়ে শুরু করা সুবিধাজনক; আগে থেকেই Trello, Jira বা অন্য shared board থাকলে সেটিও ঠিক আছে। Status, Owner, Priority, Milestone আর Estimate field রাখো; risk ও dependency label বা issue body-তে লেখো। প্রতি task-এর একটিই record রাখো; chat-এ আলাদা status না রেখে repo link করো।",
        ),
      },
      {
        title: l(
          "Split by usable behavior",
          "ব্যবহারযোগ্য behavior ধরে ভাগ করো",
        ),
        body: l(
          ...
          "Outcome → milestone → user-visible slice → implementation ও test task। একটি slice UI, logic আর data মিলিয়ে ছোট behavior দেয়; specialist-রা subtask নিতে পারে। প্রতি task আনুমানিক অর্ধ দিন থেকে দুই দিনের focused কাজের মতো রাখো। Risk estimate না হলে question, experiment আর decision-সহ সময়-বাঁধা research spike করো—অন্তহীন “research” card নয়।",
        ),
      },
      {
        title: l("Define Ready and Done", "Ready আর Done স্পষ্ট করো"),
        body: l(
      ...
      },
      {
        ...
        body: l(
          ...
          "Backlog → Ready → In progress → In review → Verify → Done। Blocked হলে কারণ, সাহায্যকারী আর next check-in লেখো; Done-এ লুকিও না। শুরুতে জনপ্রতি একটি active implementation task রাখো। নতুন কাজের আগে অপেক্ষায় থাকা review দেখো। Acceptance fail হলে reproducible defect-সহ In progress-এ ফেরাও; চাপ দিয়ে নয়, অভিজ্ঞতা দিয়ে estimate বদলাও।",
        ),
      },
    ],
    example: {
      ...
      lines: [
        ...
        l(
          ...
          "Issue #42: atomic conflict protection দাও। Owner: একজন implementer; reviewer: অন্য teammate। Dependency: time-zone আর interval rule ঠিক করা। Estimate: এক focused দিন ও review; database spike-এর পরে দরকার হলে বদলাও।",
        ),
        l(
  ...
  },
  {
    ...
    summary: l(
      ...
      "Git local history রাখে; hosted repository team-কে একসঙ্গে কাজ আর shared work recover করতে সাহায্য করে। Brief আর setup instruction দিয়েই শুরু করো, submission-এর আগের রাতে নয়।",
    ),
    steps: [
      {
        title: l("Create one shared home", "একটি shared home বানাও"),
        body: l(
          ...
          "Maintainer repository খুলে প্রত্যেকের নিজস্ব account-এ invite করবে, প্রয়োজনমতো permission দেবে। Supervisor আর data owner-এর সঙ্গে visibility ঠিক করো; public সবসময় উপযুক্ত নয়। Account protection চালু করো। অন্যরা সেই repository clone করবে; ZIP বা আলাদা অসংযুক্ত copy দিয়ে teamwork নয়।",
        ),
      },
      {
        ...
        body: l(
          ...
          "README-তে purpose, prerequisite আর exact setup/test command; stack অনুযায়ী ignore file; safe .env.example; package lockfile; আর branch/review-সহ contribution guide রাখো। Rights holder-এর সঙ্গে licensing ঠিক করো; নিজের নয় এমন কাজের license দিও না। Diff দেখে ছোট logical change commit করো; নিয়মিত push করো, যেন শুধু local copy না থাকে।",
        ),
      },
      {
        title: l("Organize for the chosen stack", "Stack অনুযায়ী folder সাজাও"),
        body: l(
          ...
          "Application source, test, docs, automation আর configuration আলাদা বোঝা যায় এমন রাখো। নতুন layer বানানোর আগে framework-এর convention মানো। Web app-এ src/, tests/, docs/, scripts/ আর .github/workflows/ হতে পারে; research-এ reproducible experiment config ও data manifest লাগতে পারে। Migration আর safe sample data version করো, live database dump বা generated dependency/build folder নয়।",
        ),
      },
      {
        title: l(
          "Protect data and recoverability",
          "Data আর recovery রক্ষা করো",
        ),
        body: l(
          ...
          "Password, token, personal record আর অনুমতিহীন dataset Git, issue বা screenshot-এ রেখো না। Private repo secret vault নয়। অনুমোদিত বড় artifact আলাদা রেখে version/checksum ও access instruction দাও। Code থেকে আলাদা data backup আর restore test করো। Credential leak হলে দ্রুত revoke/rotate, দায়িত্বশীল owner-কে জানানো আর host-এর cleanup process মানো; শুধু file delete যথেষ্ট নয়।",
        ),
      },
    ],
    example: {
      ...
      lines: [
        l(
          ...
          "Teammate নতুন folder-এ clone করে শুধু README মেনে locked dependency install ও সবচেয়ে ছোট check চালাবে। কোথায় আটকাল লিখে instruction ঠিক করে আবার করবে। কোন folder generated আর কোন evidence Git-এ থাকবে এখনই ঠিক করো।",
        ),
      ],
    },
  ...
  },
  {
    ...
    title: l(
      ...
      "সহজ branch → review → merge flow নাও",
    ),
    ...
    summary: l(
      ...
      "ছোট student team-এ short-lived feature branch আর working main রাখো। এটি GitHub-flow ধরনের পরামর্শ; ভারী Gitflow-এর develop/release branch বাধ্যতামূলক নয়।",
    ),
    steps: [
      {
        title: l("Agree the main-branch rules", "Main branch-এর নিয়ম ঠিক করো"),
        body: l(
          ...
          "Main runnable রাখো। Hosting plan-এ সম্ভব হলে pull request, অন্তত একটি peer approval আর passing CI বাধ্যতামূলক করো; shared branch-এ force push নিষিদ্ধ রাখো। না হলে একই review gate team agreement দিয়ে মানো—server enforce করে এমন দাবি নয়। একাধিক version সত্যি maintain করলেই long-lived release branch ভাবো।",
        ),
      },
      {
        title: l(
          "Branch from an up-to-date main",
          "Updated main থেকে branch করো",
        ),
        body: l(
          ...
          "Switch করার আগে git status দেখো। আগে unrelated local কাজ শেষ করো বা নিরাপদে সংরক্ষণ করো। --ff-only দিয়ে main pull, feature/42-booking-conflict-এর মতো branch, তারপর staged diff দেখে শুধু relevant file commit করো। Branch push করে risky approach হলে শুরুতেই draft PR খোলো।",
        ),
      },
      {
        title: l(
          "Review behavior, not just formatting",
          "শুধু formatting নয়, behavior review করো",
        ),
        body: l(
          ...
          "Issue আর acceptance criteria link করো; কী বদলেছে, কেন, কীভাবে test, risk আর দরকারি screenshot দাও। Reviewer logic, failure case, test, accessibility/security ও docs দেখবে; সম্ভব হলে চালাবে। Feedback blocking নাকি optional বলো; code নিয়ে কথা বলো, মানুষ নিয়ে নয়। Author fix ও evidence দিয়ে re-review চাইবে।",
        ),
      },
      {
        title: l("Resolve conflicts together", "Conflict একসঙ্গে বোঝো"),
        body: l(
          ...
          "Overlapping edit কে coordinate করবে ঠিক করো। Main বদলালে fetch-এর পরে feature branch-এ origin/main merge করে অন্য author-এর সঙ্গে intended behavior বুঝে conflict মেটাও; আবার test ও push করো। অন্ধভাবে “ours/theirs” বা reset --hard দিয়ে conflict লুকিও না। Update অস্পষ্ট হলে shared history বদলানোর আগে pair review করো।",
        ),
      },
      {
        title: l(
          "Merge, verify and release deliberately",
          "বুঝে merge, verify আর release করো",
        ),
        body: l(
          ...
          "Approval আর fresh passing check-এর পরে team convention হলে squash-merge, merged feature branch delete আর integrated acceptance criteria verify করো। Task status ও evidence update করো। Main-এর tested milestone tag করো; সব commit release নয়। Bad merge reviewed revert/fix PR দিয়ে ঠিক করো; deployment rollback-এর আগে data compatibility ভাবো।",
        ),
      },
    ],
    example: {
      ...
      lines: [
        l(
          ...
          "Clean working tree-তে এক লাইন করে চালাও। উদাহরণের path তোমার project-এ থাকতে হবে; নিজের changed file, issue আর branch বসাও। Error এলে থেমে পড়ো। এই command-এর পরে PR-এ review ও merge হবে।",
        ),
      ],
  ...
  },
  {
    ...
    title: l(
      ...
      "Sync-up ছোট, decision লিখিত রাখো",
    ),
    when: l(
    ...
    summary: l(
      ...
      "Call দিয়ে blocker সরাও আর decision নাও; task board পড়ে শোনানোর জন্য নয়। Written update অনুপস্থিত teammate-কে যুক্ত রাখে, report-এর evidence-ও হয়।",
    ),
    steps: [
      {
        title: l(
          "Send an asynchronous three-line update",
          "Async তিন লাইনের update দাও",
        ),
        body: l(
          ...
          "ঠিক করা workday-তে লেখো: আগের update থেকে কী শেষ + issue/PR link; পরের কাজ; blocker + কী সাহায্য লাগবে। আগে board update করো। Class আর ঘুমের সময় মেনে response window রাখো। Blocker পেলে তখনই জানাও, পরের call পর্যন্ত অপেক্ষা নয়।",
        ),
      },
      {
        title: l(
          "Try a 15-minute sync when needed",
          "দরকার হলে ১৫ মিনিটের sync করো",
        ),
        body: l(
          ...
          "আগে agenda আর link দাও। মিনিট ০–৩: milestone ও blocked card দেখো। ৩–১০: decision নাও বা investigation-এর pair ঠিক করো। ১০–১৫: প্রতিটি action-এর owner আর due/check-in date নিশ্চিত করো। Deep debugging দরকারি মানুষ নিয়ে আলাদা follow-up-এ করো। Written update-এই সমাধান হলে call বাদ দাও।",
        ),
      },
      {
        title: l(
          "Demo weekly, improve one habit",
          "সাপ্তাহিক demo, একটি habit উন্নত করো",
        ),
        body: l(
          ...
          "২০–৩০ মিনিটে integrated slice acceptance criteria মিলিয়ে দেখাও, failure-সহ—শুধু slide নয়। ঠিক করা review-এ supervisor-এর decision চাও। তারপর ১০ মিনিটে কী সাহায্য করেছে, কী সমস্যা আর পরের সপ্তাহে একটি process change ঠিক করো। বাকি capacity দেখে unfinished কাজ replan করো; সব task চুপচাপ carry করো না।",
        ),
      },
      {
        title: l("Leave a decision trail", "Decision-এর trail রাখো"),
        body: l(
          ...
          "ছোট note দাও: date, attendee, decision ও কারণ, owner/date-সহ action, unresolved question আর issue/ADR link। অনুপস্থিতদের summary দাও; চুপ থাকাকে approval ধরো না, disagreement নিশ্চিত করো। Consent ছাড়া call record বা public note-এ private participant information রেখো না।",
        ),
      },
    ],
    example: {
