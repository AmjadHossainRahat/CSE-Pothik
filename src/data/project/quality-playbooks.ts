...
export const qualityPlaybooks: ProjectPlaybook[] = [
  {
    ...
    title: l(
      ...
      "Coverage trophy নয়, risk ধরে test করুন",
    ),
    when: l(
    ...
    summary: l(
      ...
      "Implementation-এর আগে test approach লিখুন। Rule-এর জন্য দ্রুত focused check, boundary-তে integration test আর জরুরি user journey-তে অল্প end-to-end test রাখুন।",
    ),
    steps: [
      {
        title: l(
          "Choose the highest-risk behaviors",
          "সবচেয়ে risky behavior বেছে নিন",
        ),
        body: l(
          ...
          "প্রতি requirement-এ কী fail হতে পারে আর impact লিখুন। Cosmetic issue-এর আগে data loss/corruption, unauthorized access, ভুল result আর unusable core journey দেখুন। প্রতি test-এ ID, requirement, level, owner, setup, input, action আর expected result রাখুন। না চালালে not-run লিখুন; planned test pass-এর evidence নয়।",
        ),
      },
      {
        title: l(
          "Test rules and real boundaries",
          "Rule আর বাস্তব boundary test করুন",
        ),
        body: l(
          ...
          "Unit test-এ deterministic logic আলাদা করে empty input, boundary আর invalid state দেখুন। Integration test-এ isolated test environment-এ real database constraint, migration বা service contract যাচাই করুন। দরকারে external service mock করুন, কিন্তু যে database behavior যাচাইয়ের দাবি করছেন সেটিই mock করবেন না। Test data reset আর সম্ভব হলে clock/randomness control করুন।",
        ),
      },
      {
        title: l(
          "Verify the user journey and failures",
          "User journey আর failure যাচাই করুন",
        ),
        body: l(
          ...
          "User-visible behavior আর stable accessible locator দিয়ে অল্প critical end-to-end journey automate করুন। Success, validation, permission, empty/error state আর recovery দেখুন। অকারণ sleep বা পরস্পরকে প্রভাবিত করা shared test account এড়াও। Local development-এর সঙ্গে real deployment path-এ production build test করুন।",
        ),
      },
      {
        title: l(
          "Add manual and specialist checks",
          "Manual আর specialist check যোগ করুন",
        ),
        body: l(
          ...
          "Interface-এ keyboard-only use, visible focus, label, zoom, সরু screen আর relevant language/theme দেখুন; automated accessibility scan conformance প্রমাণ করে না। অনুমোদিত sandbox-এ role permission, secret handling আর invalid input দেখুন। মাপার আগে device, dataset ও workload-সহ বাস্তব performance target ঠিক করুন। Project-type section মেনে ML, hardware ও network evidence বদলান; web E2E model evaluation বা hardware safety-এর বিকল্প নয়।",
        ),
      },
      {
        title: l(
          "Turn defects into regression evidence",
          "Defect থেকে regression evidence বানান",
        ),
        body: l(
          ...
          "Bug report-এ environment/commit, ছোট reproduction, expected বনাম actual, impact আর safe log দিন। Severity (ক্ষতি) আর priority (কখন fix) আলাদা করুন। Reproduce, সম্ভব হলে failing regression test, fix, affected test ও core journey আবার চালান, তারপর peer verification। Flaky test খতিয়ে দেখুন; retry দিয়ে failure লুকাবেন না। Coverage gap খুঁজতে সাহায্য করে, কিন্তু ১০০% correctness প্রমাণ নয়।",
        ),
      },
    ],
    example: {
      ...
      lines: [
        l(
          ...
          "Unit: agreed rule অনুযায়ী পাশাপাশি interval overlap নয়; invalid/উল্টো interval reject। Integration: empty isolated database আর দুই valid user দিয়ে একই slot-এ concurrently reservation দিন; ঠিক এক success, এক conflict আর এক stored booking assert করুন।",
        ),
        l(
        ...
        l(
          ...
          "Run record: commit/tag, database ও app version, fixture, command, timestamp, expected/actual, pass/fail/blocked/not-run আর log বা screenshot। Release candidate-এ আবার চালিয়ে failure issue-তে link করুন। বানানো pass count, latency বা screenshot নয়।",
        ),
      ],
    },
  ...
  },
  {
    ...
    title: l(
      ...
      "Check repeatable, release recoverable করুন",
    ),
    when: l(
    ...
    summary: l(
      ...
      "Continuous integration change প্রস্তাবের সময় agreed check চালায়। ছোট করে শুরু করুন, check বিশ্বাসযোগ্য রাখুন, আর যে artifact test ও handover করবে সেটিই build করুন।",
    ),
    steps: [
      {
        title: l(
          "Create a fast pull-request gate",
          "দ্রুত pull-request gate বানান",
        ),
        body: l(
          ...
          "Pull request আর main update-এ clean runner, pinned runtime ও locked dependency install রাখুন। Formatting check (চুপচাপ auto-fix নয়), lint/static check, unit ও relevant integration test, তারপর production build চালান। Content site-এ schema/content check দিন। Local ও CI-তে একই documented command; skipped check-কে pass বলবে না।",
        ),
      },
      {
        title: l("Test the release candidate", "Release candidate test করুন"),
        body: l(
          ...
          "Built artifact isolated test environment-এ serve করে critical E2E চালান। Milestone tag-এর আগে broader regression, accessibility/manual check, migration ও recovery rehearsal, আর অন্য কাউকে দিয়ে clean setup করান। Safe fixture ও third-party stub নিন; student CI যেন real card charge, user-কে email বা production data modify না করে।",
        ),
      },
      {
        title: l(
          "Keep logs safe and failures visible",
          "Log নিরাপদ, failure দৃশ্যমান রাখুন",
        ),
        body: l(
          ...
          "CI-তে minimum permission আর প্রয়োজন হলেই protected secret দিন; untrusted pull-request code-এ secret দেবেন না। Personal data বাদ দিয়ে test report ও দরকারি failure artifact সীমিত retention-এ রাখুন। Merge-এর আগে failed gate fix করুন; approved exception হলে owner ও follow-up লিখুন, green করতে test বন্ধ নয়।",
        ),
      },
      {
        title: l(
          "Practice a release and a handover",
          "Release আর handover rehearsal করুন",
        ),
        body: l(
          ...
          "Tested commit/tag, দরকারে artifact checksum, config, migration step, known limit আর release owner লিখুন। Smoke test ও safe rollback/restore rehearsal করুন; code rollback incompatible data migration উল্টাতে পারে না। পরের maintainer-কে setup, architecture decision, test command, open issue ও access-transfer instruction দিন, report-এ secret নয়। Rubric অনুমতি দিলে offline demo backup রাখুন।",
        ),
      },
    ],
    example: {
      ...
      lines: [
        l(
          ...
          "Pull request → clean install → format/lint/type check → unit/integration test → production build → preview smoke/E2E → peer review → merge। Milestone-এ full regression, manual check আর independent reproduction করে verified commit tag করুন।",
        ),
        l(
