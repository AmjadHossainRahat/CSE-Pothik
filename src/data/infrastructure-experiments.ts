...
export const infrastructureExperiments: ExperimentSeed[] = [
  {
    ...
    title: l(
      ...
      "নিজের lab-এ একটি request কোথা দিয়ে যায়, খুঁজে দেখুন",
    ),
    duration: "60–90 min",
    prerequisites: [
      l(
    ...
    goals: [
      l(
        ...
        "Command collect নয়—packet evidence আর নিয়ন্ত্রিত failure diagnosis অনুভব করুন।",
      ),
    ],
    steps: [
      l(
        ...
        "চেনা tool দিয়ে loopback-এ ছোট HTTP server চালান। Address আর port লিখে browser → loopback → server আঁকুন।",
      ),
      l(
        ...
        "শুধু loopback interface বেছে server port-এর filter দিন। নিরীহ local page request করে সঙ্গে সঙ্গে capture বন্ধ করুন।",
      ),
      l(
        ...
        "TCP conversation আর HTTP response খুঁজে source/destination port বোঝান; কেন local request-এ router hop লাগে না বলুন।",
      ),
      l(
        ...
        "শুধু test server বন্ধ করে request আবার দিন; failure evidence compare করুন। Server ফিরিয়ে recovery যাচাই; system-wide firewall বা DNS বদলিও না।",
      ),
      l(
        ...
        "ছোট incident note লিখুন: লক্ষণ, evidence, কারণ, fix আর lab কী প্রমাণ করে না। Capture private রাখুন; share-এর আগে sensitive payload সরান।",
      ),
    ],
    attention: [
      l(
      ...
      l(
        ...
        "Peer কি আপনার observation আর ব্যাখ্যা আলাদা করতে পারবে?",
      ),
    ],
  ...
  },
  {
    ...
    title: l(
      ...
      "ছোট একটি logic circuit তৈরি ও যাচাই করুন",
    ),
    duration: "60–90 min",
    prerequisites: [
      l(
    ...
    goals: [
      l(
        ...
        "শুধু demo wiring নয়—specification, circuit আর স্বাধীন verification হিসেবে hardware design অনুভব করুন।",
      ),
    ],
    steps: [
      l(
        "Choose an AND gate built from NAND gates. Before implementation, write expected outputs for all four input combinations.",
        "NAND দিয়ে AND gate বেছে নিন। Implementation-এর আগে চার input combination-এর expected output লিখুন।",
      ),
      l(
        "Implement the circuit in the simulator’s HDL, drawing how the intermediate signal connects.",
        "Simulator-এর HDL-এ circuit implement করে intermediate signal-এর connection আঁকুন।",
      ),
      l(
        "Test all four cases against your independent truth table; record actual outputs.",
        "নিজের truth table দিয়ে চারটি case test করে actual output লিখুন।",
      ),
      l(
        ...
        "Copy-তে ইচ্ছা করে একটি connection ভুল দিয়ে failing case খুঁজুন আর কারণ বলুন। সঠিক circuit ফিরিয়ে সব case আবার চালান।",
      ),
      l(
        ...
        "Design, test table আর সীমাবদ্ধতা রাখুন: ideal logic verify হয়েছে, physical timing, power বা electrical safety নয়।",
      ),
    ],
    attention: [
      l(
      ...
      l(
        ...
        "Real timing আর component limit model-টিকে কীভাবে বদলায় জানতে চান?",
      ),
    ],
  ...
  },
  {
    ...
    title: l(
      ...
      "ঝুঁকি খুঁজে report করুন, তারপর fix-টি যেন টিকে থাকে তা নিশ্চিত করুন",
    ),
    duration: "75–120 min",
    prerequisites: [
      l(
    ...
    goals: [
      l(
        ...
        "QA-এর reasoning অনুভব করুন: risk বাছা, reproducible evidence আর দরকারি regression check automate করা।",
      ),
    ],
    steps: [
      l(
        "Write three acceptance criteria for saving a note. Name the most harmful failure, such as silently losing text.",
        "Note save-এর তিনটি acceptance criterion লিখুন। সবচেয়ে ক্ষতিকর failure বলুন, যেমন চুপচাপ text হারানো।",
      ),
      l(
        ...
        "১৫ মিনিট empty input, long text, repeated save আর reload explore করুন। শুধু pass/fail নয়, condition আর actual behavior লিখুন।",
      ),
      l(
        ...
        "Defect পেলে step, expected/actual result আর impact লিখুন। না পেলে coverage আর uncertainty সৎভাবে বলুন—bug বানাবেন না।",
      ),
      l(
        ...
        "Acceptance criterion থেকে save-and-reload check automate করুন। Local-এ সাময়িক defect দিয়ে সঠিক কারণে check fail হয় দেখুন।",
      ),
      l(
        "Restore or fix the app, rerun the check and explain what it still cannot test. Have a peer reproduce your report.",
        "App ফিরিয়ে বা fix করে check আবার চালান; কী test করতে পারে না বলুন। Peer-কে report reproduce করতে দিন।",
      ),
    ],
    attention: [
      l(
      ...
      l(
        ...
        "Developer-কে দোষ না দিয়ে বা zero bug promise না করে release risk বোঝাতে পারেন?",
      ),
    ],
