...
Asset type: CSE Compass homepage hero, original editorial illustration.
...
```text
Use case: precise-object-edit
Asset type: CSE Compass homepage editorial illustration.
